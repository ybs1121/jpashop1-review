...
public class MemberApiController {
    ...
    public Result membersV2(@RequestBody @Valid Member member) {
        List<MemberDto> collect = memberService.findAll().stream().map(m -> new MemberDto(m.getName())).collect(Collectors.toList());
